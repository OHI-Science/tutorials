...
TODO: screenshot of file structure, or Ning's google drawing of all the files

## Step 1: Save and register data layers

_There is a whole section in the manual (http://ohi-science.org/manual/#modifying-goal-models), should we link to it directly?_
TODO: I think the less we link to the manual the better, let's talk about that more though. 
...
*TODO: let's take new screenshots from the toolbox-demo repo; the filenames aren't so ugly anymore...*
